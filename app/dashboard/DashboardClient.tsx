    ...
    <div className="flex min-h-screen bg-zinc-50 dark:bg-black">
      <aside className="relative w-64 border-r border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <nav className="p-4">
          ...
          <Link
            href="/shared"
            className="mb-1 flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-600 transition hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-900"
          >
            <span>🔗</span>
            Shared with me
          </Link>
          ...
          {activeTab === "investors" && (
            <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <p className="mb-4 text-sm text-zinc-500 dark:text-zinc-400">
                In the Documents tab, use <strong>Share</strong> on a row to email an investor. They receive a clickable
                link to open the file and a link to <strong>Shared with me</strong> where they can see all documents
                shared with them over time.
              </p>
              <div className="flex flex-wrap gap-2">
                ...
                <Link
                  href="/shared"
                  className="inline-flex items-center justify-center rounded-lg border border-zinc-200 bg-white px-5 py-2.5 text-sm font-medium text-zinc-800 transition hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100 dark:hover:bg-zinc-900"
                >
                  Preview investor library
                </Link>
              </div>
            </div>
          )}
